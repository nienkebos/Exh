...
exhibition_bas = Exhibition.create({
  ...
  image: 'http://www.amfad.nl/Bas_van_Wieringen_files/shapeimage_1.png',
...
exhibition_francis = Exhibition.create({
  ...
  image: 'https://upload.wikimedia.org/wikipedia/en/1/1c/Francis_Bacon_%28artist%29.jpg',
...
Artwork.create({
  ...
  date: '2015',
  technique: '', image:'https://thecreatorsproject-images.vice.com/content-images/contentimage/no-slug/6cac3b131bfc402a4dae6d28e83afa7c.jpg',
  description: '',
...
Artwork.create({
  ...
  date: '2014',
  technique: '', image:'https://thecreatorsproject-images.vice.com/content-images/contentimage/no-slug/a0caf2a1ed8d0b7dc026a022b7811134.jpg',
  description: '',
  exhibition: exhibition_bas})
Artwork.create({
  artist: 'Bas van Wieringen',
  ...
  date: '2015',
  technique: '', image:'https://thecreatorsproject-images.vice.com/content-images/contentimage/no-slug/04191f3841f30f8394e337a5eee5e1ab.jpg',
  description: '',
  exhibition: exhibition_bas})
Artwork.create({
  artist: 'Bas van Wieringen',
  ...
  date: '2010',
  technique: 'Video', image:'http://www.overdose.am/wp-content/uploads/2011/08/ron-mandos3.jpg', description: 'He shows several movies on small screens all hooked up together. He performs useful tasks, like balancing a broken tree on his head, standing on a plank above the canals and more. Some of these installation were already sold on the opening night.',
  exhibition: exhibition_bas})
Artwork.create({
  artist: 'Bas van Wieringen',
  title: 'Ladder and Hanging shelf with balloon (Installation view)',
  date: '2014',
  technique: 'Photo, shelf and helium balloon', image:'http://dbprng00ikc2j.cloudfront.net/work/image/802760/mf2ji7/20140407185421-ladder_and_hanging_shelf.jpg',
  description: '',
  exhibition: exhibition_bas})
Artwork.create({
  artist: 'Bas van Wieringen',
  title: 'Moment No. 6',
  date: '2011',
  technique: 'Photograph', image:'http://dbprng00ikc2j.cloudfront.net/work/image/498221/mf2ji7/20110928052056-Moment_No._6.JPG',
  description: '',
  exhibition: exhibition_bas})
Artwork.create({
  artist: 'Bas van Wieringen',
  title: 'Moment No. 4',
  date: '2011',
  technique: 'Photograph', image:'http://dbprng00ikc2j.cloudfront.net/work/image/498218/mf2ji7/20110928051528-Moment_No._4.jpg',
  description: '',
  exhibition: exhibition_bas})
...
Artwork.create({
  ...
  date: '1979–80',
  technique: 'Oil on canvas', image:'http://images.metmuseum.org/CRDImages/ma/web-large/DT4445.jpg', description: 'As Bacon remarked to David Sylvester in 1975, “I loathe my own face. . . . I’ve done a lot of self-portraits, really because people have been dying around me like flies and I’ve nobody else left to paint but myself." ',
...
Artwork.create({
  ...
  date: '1972',
  technique: 'Oil paint and sand on 3 canvases', image:'http://www.tate.org.uk/art/images/work/T/T03/T03073_10.jpg', description: 'This work is generally considered one in a series of Black Triptychs which followed the suicide of Bacon’s lover, George Dyer. Dyer appears on the left and Bacon is on the right. The central group is derived from a photograph of wrestlers by Edward Muybridge, but also suggests a more sexual encounter. ',
  exhibition: exhibition_francis })
